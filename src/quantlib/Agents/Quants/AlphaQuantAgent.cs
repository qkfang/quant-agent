...
public class AlphaQuantAgent : QuantAgent
{
    ...
    public AlphaQuantAgent(AIProjectClient aiProjectClient, string deploymentName, ILogger? logger = null)
        : base(aiProjectClient, AgentId, "Alpha Quant", "Alpha Signals & Trading Strategies", "\u001b[32m", deploymentName, Instructions, logger)
    {
    }
}
